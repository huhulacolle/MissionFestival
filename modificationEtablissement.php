    ...
    <div class="mx-auto" style="width: 800px;">
        <table class="table table-borderless">
            ...
            <tr>
                ...
                <td>Code Postal :<input type="number" class="form-control" name="codePostal" <?php echo "value='" . $codePostal . "'" ?> maxlength="5" required>
                </td>
            </tr>
            <tr>
                <td>Ville :<input type="text" class="form-control" <?php echo "value='" . $ville . "'" ?> name="ville" maxlength="35" required></td>
                <td>Téléphone :<input type="tel" class="form-control" <?php echo "value='" . $tel . "'" ?> name="tel" maxlength="10" required></td>
                <td>E-mail :<input type="email" class="form-control" <?php echo "value='" . $adresseElectronique . "'" ?> name="adresseElectronique" maxlength="70"></td>
            </tr>
            <tr>
                <td></td>
                <br> <br>
