...
<?php echo "<form method='POST' action='modificationEtablissement.php?action=demanderModifEtab&idEtablissement=". $id ."'>"; ?>
    ...
    <div class="mx-auto" style="width: 800px;">
        <table class="table table-hover">
            ...
            <tr>
                <td>Nom : <input type="text" class="form-control" name="nom" <?php echo "value='" . $nom . "'" ?>  maxlength="45" required></td>
                <td>Adresse :<input type="text" class="form-control" name="adresseRue" <?php echo "value='" . $adresseRue . "'" ?> maxlength="45" required></td>
                <td>Code Postal :<input type="number" class="form-control" name="codePostal" <?php echo "value='" . $codePostal . "'" ?> onKeyDown="if(this.value.length==5 && event.keyCode!=8) return false;"></td>
            </tr>
            <tr>
                <td>Ville :<input type="text" class="form-control" name="ville" <?php echo "value='" . $ville . "'" ?>  maxlength="35" required></td>
                <td>Téléphone :<input type="tel" class="form-control" name="tel" <?php echo "value='" . $tel . "'" ?> maxlength="10" required></td>
                <td>E-mail (non obligatoire) :<input type="email" class="form-control" <?php echo "value='" . $adresseElectronique . "'" ?> name="adresseElectronique"
                        maxlength="70"></td>
            </tr>
            <tr>
                <br> <br>
            ...
            <tr>
                ...
                <td> <br> Nom : <input type="text" class="form-control"  <?php echo "value='" . $nomResponsable . "'" ?> name="nomResponsable" size="26" maxlength="25">
                </td>
                <td> <br> Prénom : <input type="text" class="form-control"  <?php echo "value='" . $prenomResponsable . "'" ?> name="prenomResponsable" size="26"
                        maxlength="25"> </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td> <br> Nombre chambres offertes :<input type="number" class="form-control"
                        name="nombreChambresOffertes" <?php echo "value='" . $nombreChambresOffertes . "'" ?> onKeyDown="if(this.value.length==3 && event.keyCode!=8) return false;"></td>
